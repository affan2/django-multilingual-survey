...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SurveyAnswer.position'
        db.delete_column(u'multilingual_survey_surveyanswer', 'position')


    def backwards(self, orm):
        # Adding field 'SurveyQuestion.position'
        db.add_column(u'multilingual_survey_surveyquestion', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'SurveyAnswer.position'
        db.add_column(u'multilingual_survey_surveyanswer', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)
