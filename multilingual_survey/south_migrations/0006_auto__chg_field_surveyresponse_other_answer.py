...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SurveyResponse.other_answer'
        db.alter_column(u'multilingual_survey_surveyresponse', 'other_answer', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'SurveyResponse.other_answer'
        db.alter_column(u'multilingual_survey_surveyresponse', 'other_answer', self.gf('django.db.models.fields.CharField')(max_length=1024))
    ...
    models = {
        ...
        u'multilingual_survey.surveyresponse': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_answer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
