...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyTranslation.description'
        db.add_column(u'multilingual_survey_survey_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyTranslation.description'
        db.delete_column(u'multilingual_survey_survey_translation', 'description')
